...
// ListHistory satisfies CardStore for tests that predate the audit endpoint.
func (f *fakeStore) ListHistory(context.Context, uuid.UUID, int) ([]HistoryEntry, error) {
	return nil, nil
}
